...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.smpl_model_path = os.getcwd() + '/data/smpl/smpl'
        self.smplx_model_path = os.getcwd() + '/data/smpl/smplx'
        self.test_folder = os.getcwd() + '/data/test_pose'
        ...
        self.query_posmap_size= 512 #512
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        self.epochs = 20     # total epochs for training 
        ...
        self.lambda_pose = 10
        self.lambda_rgl = 1e1
        self.log_iter = 100 #2000
        self.lpips_start_iter = 30000
        self.pose_op_start_iter = 0  #define when to start pose optimization, >epochs means no optimization
        self.lr_net = 3e-3
        self.lr_geomfeat = 5e-4

        self.sched_milestones = [int(100/ 3), int(100 *2/ 3)] #[int(self.epochs/ 3), int(self.epochs *2/ 3)]
